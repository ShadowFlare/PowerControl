...
if [ -e "${plugin_dir}/${package}/bin/ryzenadj" ]; then
  sudo mv "${plugin_dir}/${package}/bin/ryzenadj" "${temp}/${package}/bin/ryzenadj"
fi  
sudo rm "${temp}/${package}/backend/portio.so"
if [ -e "${plugin_dir}/${package}/backend/portio.so" ]; then
  sudo mv "${plugin_dir}/${package}/backend/portio.so" "${temp}/${package}/backend/portio.so"
fi
